...
//  // BY USING FOR LOOP BABYYY!!

//  for (int i = 0; i <4 ; i++)
//  {
//     cout<<Hills[i]<<endl;
//  }
//  // OH YEAH THATS MY GIRL U GOT IT MUAHH......
//     return 0;
// }
...
// using namespace std;
// int main(){
//          int my_array[5]={12,13,14,15,17};
//          for (int i = 0; i < 5; i++)
//          {
//             cout<<"THE VALUE OF ARRAY "<<i<< " IS:  "<<my_array[i]<<endl;
//          }
...
// int main(){
    ...
    // for(int j = 0; j < 34; j++)  
    // {
    //     cout << "The value of jojo[" << j << "]: " << jojo[j] << endl;
    // }
